"""
Stream Highlights Desktop - Aplikacja GUI dla streamów
Wersja: 2.0.0 - SMART SPLITTER EDITION
Python 3.11+ | PyQt6 | CUDA

Automatyczne generowanie najlepszych momentów z live streamów
...
class StreamHighlightsApp(QMainWindow):
    """Główne okno aplikacji Stream Highlights"""
    ...
    def init_ui(self):
        ...
        self.setWindowTitle("Stream Highlights AI - Automated Video Compiler v2.0")
    ...
    def create_header(self) -> QWidget:
        ...
        # Tytuł
        title = QLabel("🎮 Stream Highlights AI v2.0")
    ...
    def create_file_input_section(self) -> QGroupBox:
        ...
        self.url_input.setPlaceholderText("https://youtube.com/watch?v=... lub Twitch URL")
    ...
    def create_output_tab(self) -> QWidget:
        ...
        self.add_transitions.setChecked(False)
        ...
        self.shorts_count.setEnabled(False)
    ...
    def create_smart_splitter_tab(self) -> QWidget:
        ...
        # Use politicians in titles - DISABLED for streams
        self.use_politicians = QCheckBox("👔 Używaj nazwisk w tytułach (wyłączone dla streamów)")
        self.use_politicians.setChecked(False)
        self.use_politicians.setEnabled(False)
        self.use_politicians.setToolTip("Ta opcja jest aktywna tylko w aplikacji Sejm")
    ...
    def create_youtube_tab(self) -> QWidget:
        ...
        # Load profiles from config - DEFAULT TO "stream"
        ...
        if profile_names:
            ...
            # Set default to "stream" for stream app
            if "stream" in profile_names:
                self.youtube_profile.setCurrentText("stream")
        else:
...
"""
    ...
    def update_config_from_gui(self):
        ...
        if hasattr(self.config, 'splitter'):
            ...
            self.config.splitter.use_politicians_in_titles = False  # Always False for streams
    ...
    def update_strategy_example(self):
        ...
        if example_duration >= min_split:
            ...
            strategy_text = f"""
<b>Przykład: 5h live stream</b><br>
