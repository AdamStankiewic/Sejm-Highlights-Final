...
class ChatAnalyzer:
    ...
    def get_chat_score(self, start_time: float, end_time: float) -> float:
        ...
        # Combine scores
        # Activity: 0-50 points (capped at 10x baseline = 50 points)
        # IMPROVED: Changed from 5x to 10x for better detection of viral moments
        activity_points = min((activity_mult - 1) * 5.56, 50)  # 10x baseline = 50 pts
